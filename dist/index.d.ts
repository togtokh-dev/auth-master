...
declare const _default: {
    ...
    config: configType;
    checkTokenBearer: (users: [string], options?: optionsType) => (req: authMasterRequest, res: Response<any, Record<string, any>>, next: NextFunction) => Promise<1 | Response<any, Record<string, any>>>;
